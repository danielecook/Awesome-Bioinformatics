...
- **[MA plot](https://michaelaupetit.shinyapps.io/EnhancedMAplot_V2/)** - R-Shiny MA plot for interactively selecting/filtering/grouping/exporting genes based on MA data. [ [paper-2020](http://biovis.net/2020/files/BioVis2020__Interactive_MA_plot%20-%20Ali%20Sheharyar.pdf) | [web](https://github.com/alisheharyar/Enhanced_MA_Plot) ]
- **[Lucid Align](https://lucidalign.com)** - A modern sequence alignment viewer. [ [web](https://lucidalign.com) ]
