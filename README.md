...
- [Bioinformatics Notebook](https://github.com/rnnh/bioinfo-notebook) - Scripts for bioinformatics pipelines, with quick start guides for programs and video demonstrations.
